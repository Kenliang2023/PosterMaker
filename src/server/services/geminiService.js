...
要求每个方案都包含：
- 独特的风格名称和简短描述
- 产品在海报中的位置（产品图片只能占画面25-35%的面积，必须确保背景环境清晰可见）
- 背景描述和场景设定（必须是与产品功能相关的真实应用场景）
- 产品特点文字的位置和布局（明确描述文字的相对位置和排列方式，布局要合理，提升画面整体美感）
...
- 海报上显示的文字内容（这些文字必须显示在最终海报上，布局要合理，美观）：
